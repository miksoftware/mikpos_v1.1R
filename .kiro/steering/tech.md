...
- **Ingredients**: ingredients, ingredient_groups, ingredient_group_options
- **Composite Products**: product_ingredients (pivot), product_ingredient_groups (pivot)
- **Services**: services
- **Restaurant**: zones, restaurant_tables
