        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-slate-200">
                <thead class="bg-slate-50">
                    <tr>
                        <th class="px-6 py-4 text-left text-sm font-semibold text-slate-500 uppercase">Municipio</th>
                        <th class="px-6 py-4 text-left text-sm font-semibold text-slate-500 uppercase">Departamento</th>
                        <th class="px-6 py-4 text-center text-sm font-semibold text-slate-500 uppercase">Código DIAN</th>
                ...
                <tbody class="divide-y divide-slate-200">
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-center">
                            ...
                            <span class="inline-flex items-center px-2.5 py-1 rounded-full text-sm font-mono font-medium bg-blue-100 text-blue-700">{{ $municipality->dian_code }}</span>
                            @else
                        ...
                        <td class="px-6 py-4 text-center">
                            ...
                            @else
                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-sm font-medium {{ $municipality->is_active ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700' }}">{{ $municipality->is_active ? 'Activo' : 'Inactivo' }}</span>
                            @endif
                        </td>
                ...
                <div class="relative w-full max-w-md bg-white rounded-2xl shadow-xl">
                    ...
                    <div class="px-6 py-4 space-y-4">
                        ...
                        <div>
                            ...
                            @error('dian_code') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
